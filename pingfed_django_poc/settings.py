"""
Django settings for pingfed_django_poc project.
...
SECRET_KEY = 'django-insecure-pq24n4zehbe)j)$&7ct=gb!+tind$ns)b3um%9-e#_*got82-o'
...
WSGI_APPLICATION = 'pingfed_django_poc.wsgi.application'
...
# PINGFED VARIABLES
PINGFED_PICKUP_URL = env('PINGFED_PICKUP_URL')
